...
// Función para eliminar estado sin recargar
const destroy = (id) => {
...
<template>
  <AuthenticatedLayout>
    <div class="container mx-auto p-6">
      <h1 class="text-2xl font-bold mb-6 tituloPag">Lista de Estados</h1>
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full bg-white border rounded-lg shadow text-black">
          ...
          <tbody>
            <tr v-for="estado in estados" :key="estado.id" class="hover:bg-gray-50">
              ...
              <td class="py-2 px-4 border-b flex justify-center gap-2">
                ...
                <a
                  ...
                  title="Ver"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 fill-white" viewBox="0 0 576 512">
