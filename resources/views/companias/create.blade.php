...
<div class="container mx-auto p-6">
    <h1 class="text-2xl font-bold mb-4">➕ Registrar Nueva Compañía</h1>
    ...
    {{-- Formulario --}}
    <form action="{{ route('companias.store') }}" method="POST" class="bg-white p-6 rounded shadow-md">
        @csrf
        ...
        <div class="mb-4">
            ...
            <textarea name="descripcion" rows="3"
                      class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring focus:ring-blue-300">{{ old('descripcion') }}</textarea>
        </div>
